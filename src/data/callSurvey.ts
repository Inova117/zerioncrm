...
export const SURVEY_QUESTIONS: SurveyQuestion[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'negociando', label: 'Reunión agendada / negociando precio' },
      { id: 'demo-enviada', label: 'Aceptó ver la página — demo enviada' },
      { id: 'en-contacto', label: 'Quedó interesado — seguimiento' },
      { id: 'reactivacion', label: 'Vio la página y NO la quiere' },
