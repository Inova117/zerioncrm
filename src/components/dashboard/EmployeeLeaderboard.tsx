      ...
      <table className="w-full min-w-[540px] text-sm">
        <thead>
          <tr className="border-b border-surface-200 text-left text-xs uppercase tracking-wide text-surface-400">
            ...
            <th className="px-2 py-2 text-center font-medium">En contacto</th>
            <th className="px-2 py-2 text-center font-medium">Demos</th>
            <th className="px-2 py-2 text-center font-medium">Negociando</th>
          ...
          {stats.map((s) => {
            ...
            return (
              <tr key={s.user.id} className="border-b border-surface-100 last:border-0">
                ...
                <td className="px-2 py-3 text-center text-blue-600">{s.enContacto}</td>
                <td className="px-2 py-3 text-center text-amber-600">{s.demos}</td>
                <td className="px-2 py-3 text-center text-red-600">{s.negociando}</td>
