...
-- Espejo de supabase/migrations/20260826000000_prospectos.sql.
-- ============================================================================
...
--   --   prospecting_campaigns, prospecting_decisions, prospectos,
--   --   roadmap_activities, roadmap_cash, roadmap_clients, roadmap_days,
--   --   roadmap_meta, tasks
--
--   select count(*) as policies from pg_policies where schemaname = 'public';
--   -- Debe dar: 32 (22 base + 5 del roadmap + 1 de daily_activity + 2 de campaigns + 1 de decisions + 1 de prospectos)
-- ============================================================================
